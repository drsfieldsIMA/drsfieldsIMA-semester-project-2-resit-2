...
export const ALL_ARTICLE_ENTRIES = [
  {
    "id": "1",
    "title": "England's IPL players likely to miss test series against New Zealand",
    "slug": "england's-ipl-players-likely-to-miss-test-series-against-new-zealand",
    "date": "June 09, 2021",
    "time": "10:00 PM EST",
    "content": "England are likely to rest their Indian Premier League (IPL) 2021 players for the Test series against New Zealand in order to give the cricketers a break. New Zealand will play England in a two-match Test series which gets underway from June 2 at Lord's in London. According to a report in BBC, England players who featured in IPL 2021 before the tourtitlent was postponed will not be hurriedly picked for the Test series. Chris Woakes, Sam Curran, Moeen Ali, Jos Buttler, and Jonny Bairstow all played at least a game in the postponed IPL and are now in mandatory 10-day isolation after returning to the UK.",
  ...
  },
  {
    ...
    "date": "July 5, 2021",
    "time": "8:00 PM EST",
    "content": "World number one Novak Djokovic swept into the Italian Open quarter-finals on Thursday with a straight sets wins over Alejandro Davidovich Fokina in front of spectators who were allowed to watch in the Foro Italico for the first time. The five-time Rome champion won through 6-2, 6-1 in 1hr 10min against the 48th-ranked Spaniard with the venue filled to 25 per cent of capacity. It was not good, it was great. I missed the crowd, said the 33-year-old Serb after the match.",
  ...
  {
    "id": "11",
    "title": "Tulip inspired wind turbine that combines wind and solar energy sources.",
  ...
  ,
  {
    ...
    "date": "Jan 10, 2022",
    "time": "8:00 PM EST",
    "content": " Using our algorithm we can tell you the best plants, vegetables and fruit that thrive in your area. ",
